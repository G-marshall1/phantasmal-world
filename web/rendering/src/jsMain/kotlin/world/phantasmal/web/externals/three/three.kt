...
external class Vector3(
    ...
    /**
     * Linearly interpolates between this vector and [v], where [alpha] is the percent distance
     * along the line (0 = this vector, 1 = [v]).
     */
...
external class Uint32BufferAttribute(
    array: Uint32Array,
    itemSize: Int,
    normalize: Boolean = definedExternally,
) : BufferAttribute
