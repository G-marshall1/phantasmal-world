...
enum class WeaponType(
    ...
    RIFLE(PlayerAnimations.RIFLE, 20, reach = 21.0, angleDegrees = 10.0, maxTargets = 1),
    MECHGUN(PlayerAnimations.MECHGUN, 8, reach = 8.5, angleDegrees = 10.0, maxTargets = 1),
    SHOT(PlayerAnimations.SHOT, 16, reach = 13.0, angleDegrees = 45.0, maxTargets = 5),
    LAUNCHER(PlayerAnimations.LAUNCHER, 30, reach = 17.0, angleDegrees = 10.0, maxTargets = 4),
