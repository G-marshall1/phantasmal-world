...
val ENEMY_SPECS: List<EnemySpec> = listOf(
    ...
    EnemySpec("Darvant", "darkfalz_dat.bml", false, null, PvmSource.FromBml("df1_s_simobe.pvm"), "df1_s_simobe.nj", listOf("wait_df1_s_root.njm")),
    EnemySpec("VolOptForm1", "bm_boss3_volopt.bml", false, null, PvmSource.FromBml("me5p01_y_all.pvm"), "me5p01_y_all.nj", listOf("attack_me5p01_y_all.njm", "damage_me5p01_y_all.njm", "start_me5p01_y_all.njm", "wait_me5p01_y_all.njm")),
    EnemySpec("VolOpt", "bm_boss3_volopt.bml", false, null, PvmSource.FromBml("me5p02_y_all.pvm"), "me5p02_y_all.nj", listOf("b_attack_me5p02_y_all.njm", "damage_me5p02_y_all.njm", "death_me5p02_y_all.njm", "f_attack_me5p02_y_all.njm", "l_attack_me5p02_y_all.njm", "r_attack_me5p02_y_all.njm", "start_me5p02_y_all.njm", "wait_me5p02_y_all.njm")),
    EnemySpec("VolOptPillar", "bm_boss3_volopt.bml", false, null, PvmSource.FromBml("fs_obj_hiraishin_a.pvm"), "fs_obj_hiraishin_a.nj", listOf("fs_obj_hiraishin_a.njm", "fs_obj_hiraishin_b.njm", "fs_obj_hiraishin_c.njm")),
    EnemySpec("DeRolLe", "bm_boss2_de_rol_le.bml", false, null, PvmSource.FromBml("boss2_b_derorure_body.pvm"), "boss2_b_derorure_body.nj", listOf("beam02_boss2_b_body.njm", "beamwait_boss2_b_body.njm", "beam_a_boss2_b_body.njm", "beam_b_boss2_b_body.njm", "beam_c_boss2_b_body.njm", "bite_lloop_boss2_b_body.njm", "bite_rloop_boss2_b_body.njm", "die_boss2_b_body.njm", "enter_boss2_b_body.njm", "fd02_boss2_b_body.njm", "fjump_boss2_b_body.njm", "forward_boss2_b_body.njm", "lrjump_boss2_b_body.njm", "l_bite_boss2_b_body.njm", "rljump_boss2_b_body.njm", "r_bite_boss2_b_body.njm", "scatter_boss2_b_body.njm")),
    ...
    // The Sorcerer's Bees ("bits"): the pair that flanks it, one casting its offence and one
    // its Resta. They ride in the Sorcerer's own archive and are their own targetable enemy --
    // the wiki is explicit that both can be destroyed. Static: the model carries no clips of
    // its own, so it borrows the Sorcerer's idle to satisfy the loader.
    EnemySpec("SorcererBee", "bm_ene_re4_sorcerer_a.bml", false, null, PvmSource.FromBml("re4_b_sorcer_body.pvm"), "re4_b_bit.nj", listOf("wait_re4_b_body.njm")),
